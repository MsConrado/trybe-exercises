...
function formatedBookNames() {
  ...
  const array = books.map((string, index, array) => `${string.name} - ${string.genre} - ${string.author.name}` )
  return array 
}
...
//   let livrosMais60 = [];
//   books.find((velhos) => {
//     if (velhos.releaseYear <= 1961){
//       livrosMais60.push(velhos)
//     }
//     livrosMais60.sort((a, b) => a.releaseYear - b.releaseYear)
//   })
//   return livrosMais60
// }
...
//   let nomes = [];
//   books.filter((nome) => {
//     if (nome.genre === 'Ficção Científica' || nome.genre === 'Fantasia') {
//       nomes.push(nome.author.name)
//     }
//     return nomes
//   })
